...
var orm = {
  ...
  // INSERT INTO table (col1 (??),col2(??)) val(val1(?),val2(?))

  // the single question marks is the array of values that we have

  // double questionmarks are the column names 
  ...
  // mysql basic syntax: UPDATE table SET column=? WHERE id=?
  // 
